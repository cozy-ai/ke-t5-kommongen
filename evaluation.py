...
def main(args):
    ...
    if args.model == "ke-t5":
        model_tokenizer = T5Tokenizer.from_pretrained('KETI-AIR/ke-t5-base')
    elif args.model == "kobart":
    ...
    if args.model not in ['ke-t5', 'kobart', 'kogpt2', 'mbart-50']:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, default='ke-t5')
    parser.add_argument("--reference_file", type=str, default='examples/kommongen_test_1.1.txt')
